...
- Produce `AUTH_DATABASE_URL`, `RUNTIME_DATABASE_URL`, `BETTER_AUTH_SECRET`, `WEB_ORIGIN`, `API_INTERNAL_URL`, `SMTP_HOST`, `SMTP_PORT`, `MAILPIT_PORT`, `MAIL_FROM`, `APP_ENV=local` in ignored env.
