...
| [Khoảnh khắc](moments/README.md)     | Feature branch có API/media/UI           | Pilot thiết bị thật và production storage |
| [Kỷ niệm](memories/README.md)        | Feature branch có timeline/text/audio    | Biên tập và audience mở rộng              |
| [Nhà mình](home/README.md)           | Feature branch đã nối trải nghiệm A      | Pilot với thành viên thật                 |
