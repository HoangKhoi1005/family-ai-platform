...
| [Khoảnh khắc](moments/README.md)     | Đã có API, private media và UI trên main   | Pilot thiết bị thật và production storage |
| [Kỷ niệm](memories/README.md)        | Đã có timeline, lời kể chữ/audio trên main | Biên tập và audience mở rộng              |
| [Nhà mình](home/README.md)           | Trải nghiệm A đã nối API thật trên main    | Pilot với thành viên thật                 |
