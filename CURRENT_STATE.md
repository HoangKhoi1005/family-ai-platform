...
- PWA E2E đạt **12/12** trên Chromium desktop và Pixel 7 emulation, gồm manifest/icon/header thật, worker registration, Cache Storage rỗng, prompt theo thao tác, hướng dẫn iPhone, standalone và 320 px/200%. Hồi quy logout/revoke chọn lọc đạt **10/10**. Toàn bộ Playwright đạt **177 pass, 3 skip đúng theo project** trong 180 lượt.
- Full `npm run check` đạt ngày 2026-09-14: boundaries, design tokens, PWA safety/checker fixtures, lint, format, typecheck **13/13 Turbo tasks**, **151/151 unit tests trong 31 file**, Project Brain **69 Markdown / 4 JSON / 24 seed cases** và production build đủ 8 workspace.
