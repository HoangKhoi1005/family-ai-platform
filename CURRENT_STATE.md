...
- Gói đang thực hiện: đồng bộ Project Brain và PWA foundation riêng tư. Manifest, icon, service-worker lifecycle và hướng dẫn cài đặt chưa được coi là hoàn thành cho đến khi code, browser test và full quality gate đạt.
